/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9957f5f0c69f88450b6218b67fba4c6a)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		NODE_ENV: string;
		WEBSOCKET_HIBERNATION_SERVER: DurableObjectNamespace<import("./src/worker/index").WebSocketHibernationServer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "LAST_FM_API_KEY" | "NODE_ENV">> {}
}
